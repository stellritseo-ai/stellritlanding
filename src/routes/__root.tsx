...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StellR IT" },
      { name: "description", content: "Digital Evolution for Business" },
      { name: "author", content: "StellR IT" },
      { property: "og:title", content: "StellR IT" },
      { property: "og:description", content: "Digital Evolution for Business" },
